    ...
    <section>
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="pb-12 md:pb-20">
          {/* Tobpabr */}
          <div className="no-scrollbar flex items-center justify-between space-x-8 overflow-x-scroll border-b py-6 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.800),transparent)1]">
            {/* Links */}
          ...
          <div>
            ...
            <div className="mt-12 md:mt-16">
              <h3
                id="engineering"
                className="inline-flex scroll-mt-8 bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 bg-clip-text pb-8 text-2xl font-bold text-transparent"
              >
                Engineering
              </h3>
...
export function IntegrationCard({ item, index }: CardProps) {
  return (
    <div
      key={index}
      className="group relative rounded-3xl border border-slate-800 bg-gradient-to-tr from-slate-800 to-slate-800/25 transition-colors hover:border-slate-700/60"
    >
      <div className="flex h-full flex-col p-5">
        <div className="mb-3 flex items-center space-x-3">
          ...
          <Link
            className="bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 bg-clip-text font-semibold text-transparent group-hover:before:absolute group-hover:before:inset-0"
            href={item.link}
          >
            {item.name}
          </Link>

  ...
  return (
    <section className="relative">
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        {/* Blurred shape */}
        <div
          className="pointer-events-none absolute left-0 top-0 -z-10 -ml-16 -mt-24 opacity-70 blur-2xl"
          aria-hidden="true"
        >
        ...
        <div className="pb-12 pt-16 md:pb-20 md:pt-32">
          ...
          <div className="divide-y divide-slate-800">
            ...
            <div className="py-8 first-of-type:pt-0 last-of-type:pb-0">
              <div>
                <div className="inline-flex bg-gradient-to-r from-purple-500 to-purple-200 bg-clip-text pb-6 font-medium text-transparent">
                  API Authorization
                </div>
              </div>

  ...
  return (
    <section className="relative">
        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.800),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-20">
            ...
            <p className="text-lg text-slate-400">
              We are makers at heart. Problem solvers and storytellers. We are a
              diverse team of individuals who build things to make our customers
              happy.
            </p>
          </div>

          {/* Icons with text */}
          <div className="-m-5 mx-auto grid max-w-xs gap-6 md:max-w-none md:grid-cols-3 lg:gap-10">
            {/* Block #1 */}
            <div className="p-5 text-center">
              <div className="mb-3 inline-flex h-12 w-12 items-center justify-center rounded-full border border-transparent [background:linear-gradient(theme(colors.slate.800),_theme(colors.slate.800))_padding-box,_conic-gradient(theme(colors.slate.400),_theme(colors.slate.700)_25%,_theme(colors.slate.700)_75%,_theme(colors.slate.400)_100%)_border-box]">
              ...
              <div className="mb-1 font-bold text-slate-100">Passionate</div>
              <p className="text-sm text-slate-400">
                You are passionate about digital products of any kind and are a
                builder at heart.
              </p>
            </div>
            {/* Block #2 */}
            <div className="p-5 text-center">
              ...
              <div className="mb-1 font-bold text-slate-100">Energetic</div>
              <p className="text-sm text-slate-400">
                You are passionate about digital products of any kind and are a
                builder at heart.
              </p>
            ...
            <div className="p-5 text-center">
              ...
              <div className="mb-1 font-bold text-slate-100">Achiever</div>
              <p className="text-sm text-slate-400">
                You are passionate about digital products of any kind and are a
                builder at heart.
              </p>
      ...
      <div className="mx-auto max-w-[1440px] px-4 md:px-0">
        <div className="grid grid-cols-2 gap-4 md:-mx-5 md:grid-cols-4 lg:gap-6">
          <Image
      ...
      <div className="relative px-4 sm:px-6">
        {/* Blurred shape */}
        <div
          className="pointer-events-none absolute left-1/2 top-0 ml-24 -translate-x-1/2 translate-y-1/3 opacity-40 blur-2xl"
          aria-hidden="true"
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="434" height="427">
            <defs>
        ...
        <div className="mx-auto max-w-3xl py-12 md:py-20">
          <h3 className="h3 inline-flex bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 bg-clip-text pb-8 text-transparent md:pb-16">
            Open positions
          </h3>
          <div className="space-y-8">
            {items.map((item, index) => (
              <div key={index}>
                <h4 className="inline-flex bg-gradient-to-r from-purple-500 to-purple-200 bg-clip-text pb-3 font-medium text-transparent">
                  {item.area}
                </h4>
                <ul className="divide-y divide-slate-800">
                  {item.positions.map((position, index) => (
                    <li
                      key={index}
                      className="flex flex-col flex-wrap justify-between py-5 md:flex-row"
                    >
                      <span className="mr-2 font-medium text-slate-50">
                        {position.title}
                      </span>
                      <a

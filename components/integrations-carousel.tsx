    ...
    <>
      <div className="stellar-carousel swiper-container group">
        <div className="swiper-wrapper w-fit">
          {/* Carousel items */}
          <div className="swiper-slide group relative h-auto rounded-3xl border border-slate-800 bg-gradient-to-tr from-slate-800 to-slate-800/25 transition-colors hover:border-slate-700/60">
